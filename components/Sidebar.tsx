...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className={`mb-6 ${collapsed ? 'px-4' : 'px-6'}`}>
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              } py-3.5 rounded-lg transition-all duration-300 relative overflow-hidden ${
                isActive
      ...
      {/* Bottom Section */}
      <div className={`border-t border-slate-200 dark:border-white/5 space-y-4 ${collapsed ? 'p-4' : 'p-6'}`}>
        {!collapsed && (
          <>
